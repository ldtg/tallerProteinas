...
static char *AMINOACIDO_STRING[] = {
        "Fenilanina", "Leucina", "Serina", "Tirosina", "Cisteina", "Triptofano", "Prolina",
        "Histidina", "Acido glutamico", "Isoleucina", "Metionina", "Treonina", "Asparagina",
...
int aminoacido_comparar(aminoacido_t *self, aminoacido_t *otro){
    return strncmp(self->str_aminoacido, otro->str_aminoacido, MAX_LEN_AMINOACIDO);
}
